(function(factory) {
  ...
  if (typeof define === 'function') {
    ...
    factory(null, null, null, window);
  }

})(function(require, exports, module, window, undefined) {
...
function require(arg) {
	// 修正为支持seajs
    return (window.seajs?exports:window.less)[arg.split('/')[1]];
};
...
tree.URL = function (val, paths) {
    if (val.data) {
    	...
    	/* ust comment these lines out as we don't use any relative urls
